- [0 元语言](foundation)
  ...
  - [0.1ᐨᐞ 可枚举性](foundation.enumerability)
    - [0.1.1 可选值序列视角](foundation.enumerability.maybeview)
    - [0.1.2 累积列表视角](foundation.enumerability.listview)
      - [0.1.2.0 定义](foundation.enumerability.listview.base)
      - [0.1.2.1 实例](foundation.enumerability.listview.instance)
    - [0.1.3 普通视角](foundation.enumerability.plainview)
